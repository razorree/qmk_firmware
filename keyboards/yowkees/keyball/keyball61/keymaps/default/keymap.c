...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_LALT,  XXXXXXX   ,XXXXXXX   , XXXXXXX, LT(2,KC_SPC),LT(3,KC_DEL),        KC_BSPC,LT(2,KC_ENT),LT(1,KC_LNG2),_______ , KC_RALT,  KC_RGUI   , KC_RCTL
  ),
  ...
  [1] = LAYOUT_universal(
    ...
    _______  ,S(KC_LCTL),S(KC_LALT),S(KC_LGUI), _______  , _______  , _______  ,            _______  , _______  , _______  ,_______,   S(KC_RALT), S(KC_RGUI) ,S(KC_RCTL)
  ),

  [2] = LAYOUT_universal(
    _______  , KC_F1    , KC_F2 ,    KC_F3    , KC_F4    , KC_F5    ,                                  KC_F6    ,   KC_F7,      KC_F8,      KC_F9 ,     KC_F10,     KC_F11,
    _______  , _______  , KC_7     , KC_8     , KC_9     , _______  ,                                  KC_PGUP,     KC_HOME,    KC_UP,      KC_END,     KC_INS,     KC_F12,
    _______  , _______  , KC_BTN4  , KC_5     , KC_BTN5  ,S(KC_SCLN),                                  KC_PGDN,     KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______,
    _______  , _______  , KC_BTN1  , KC_BTN3  , KC_BTN2  ,S(KC_MINS), S(KC_8)  ,            S(KC_9)  , KC_PGDN  ,  C(KC_LEFT),  _______ ,  C(KC_RGHT),  _______,    _______,
    _______  , SCRL_MO  , _______  , _______  , _______  , _______  , _______  ,             KC_DEL  , _______  ,   _______  ,  _______ ,   _______  ,  _______,    _______
  ),
